...
def format_stats_for_site(df: pl.DataFrame, does_player_image_exist_row=False):
    ...
    column_map = {
        ...
        "result_vs_expectation_avg": "Avg Result vs Expectation (The Gospel)",
        ...
        "result_vs_expectation": "Result vs Expectation (The Gospel)",
    ...
    if does_player_image_exist_row:
        for row in output_dict:
            ...
            img_path = os.path.join("static", "player_pics_thumbs", f"{player_name}.webp")
