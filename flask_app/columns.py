...
TIPS: Dict[str, str] = {
    ...
    "team_quality": "Sum of this player's team's ratings, including the player.",
    "teammate_quality": "Sum of the other four teammates' ratings.",
    "opp_quality": "Sum of the five opponents' ratings.",
